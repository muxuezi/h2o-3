...
def vec_math_ops():
    ...
    assert ((h2o_data1.tan() - h2o.H2OFrame(np.tan(np_data1))).abs() < 1e-10 * (h2o_data1.tan().abs() + 1)).all()
    ...
    assert ((h2o_data3.acosh() - h2o.H2OFrame(np.arccosh(np_data3))).abs() < 5e-12 * h2o_data3.acosh().abs()).all()
